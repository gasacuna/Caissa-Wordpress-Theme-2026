...
<div class="foot-badges">
        ...
        <img src="<?php echo CAISSA_IMG; ?>/footer/badge-gptw.webp" alt="Certificado Great Place To Work" width="35" height="50" loading="lazy" decoding="async" />
...
function caissa_bloque_legal() {
	?>
<p>Agencia incluida en el <a href="https://www.cancilleria.gob.ar/es/directorios-argentina-creativa/marketing-publicidad-y-comunicacion/caissa" target="_blank" rel="noopener">Directorio de agencias</a> de la Cancillería Argentina.</p>
	<?php
}
